    ...
    <>
      ...
      <div className="flex flex-row items-center justify-center max-w-3xl px-8 mx-auto mt-24">
        <p className="text-2xl text-justify">
          <span className="text-6xl"></span>We are a dedicated group that is
          passionate about making the society a better place by ensuring that we
          simulate polls and ensure that all your votes count. We liase with
          civil bodies in the real world to also monitor the electoral processes
          at your polling Units and stations to ensure a free and fair election
          for everyone.
