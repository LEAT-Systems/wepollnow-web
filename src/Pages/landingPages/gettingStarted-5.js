      ...
      <div className="relative flex flex-col">
        ...
        <div className="relative flex flex-col items-center justify-center space-y-2 mt-12 bg-contain bg-hero-pattern bg-no-repeat lg:pb-[10rem] bg-top bg-opacity-5 md:py-8 pb-24">
          ...
          <div className="absolute right-6 md:right-16 top-72 md:top-36">
            <div className="flex flex-col items-center justify-center space-y-4 ">
              ...
              <div className="bg-[#EDFFF0] rounded-full hover:cursor-pointer md:p-1 ">
        ...
        <div className="w-screen ">
          <div className="relative flex flex-col w-screen mx-auto text-gray-900 md:my-6 md:flex-row md:px-0">
            ...
            <div className="max-w-3xl -mt-8 rounded-lg md:rounded px-6 md:mt-[110px] bg-[#FFF1F4]/70 p-8 z-10 backdrop-blur-md">
